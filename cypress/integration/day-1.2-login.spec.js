 ...
 * @criteria
  ...
  - If my submitted email and password are incorrect: I'm given an appropriate error message so that I can attempt to login again.
  - If my submitted email and password are correct: the app "logs me in" and redirects me to my dashboard.
...
describe(`User story: Login`, function () {
  ...
  it(`displays the email and password fields`, () => {
    ...
    cy.get("section form").within(() => {
      cy.get("label[for=login-email-input]").should("have.text", "email");
      cy.get("input#login-email-input")
  ...
  context(`Given invalid credentials`, () => {
    ...
    it(`displays error from POSTS /api/auth/token`, () => {
      ...
      cy.get("main form").within(($form) => {
        cy.get("#login-email-input").type(newUser.email);
  ...
  context(`Given valid credentials`, () => {
    ...
    it(`stores token in localStorage and redirects to /`, () => {
      ...
      cy.get("main form").within(($form) => {
        cy.get("#login-email-input").type(loginUser.email);
